package david.ceballos.demo.scenes.help
...
class HelpActivity : BaseActivity() {
    ...
    private fun configureActivity() {
        ...
        this.binding.icBack.setOnClickListener { this.finish() } //Finaliz la actividad
    }
    ...
    private fun initializePlayer() {
        ...
        this.player = ExoPlayer.Builder(this).build().also { exoPlayer ->
            ...
            // Crea un mediaItem y carga multimedia (Pueed ser URL o archivo local ram/assests). Paso 3
